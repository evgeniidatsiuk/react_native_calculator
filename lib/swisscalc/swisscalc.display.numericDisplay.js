...
// maxLength: Maximum number of characters to result (default: 20)
...
// Adds the given character to the result, if appropriate.
...
global.swisscalc.display.numericDisplay.prototype.addDigit = function(digit) {
	...
	// If not a decimal and result is empty, remove 0...
...
// Formats the value and sets the result. "val" should be a number.
