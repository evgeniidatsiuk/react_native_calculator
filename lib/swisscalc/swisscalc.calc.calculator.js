...
// Adds the given digit, or starts the result over if applicable.
...
// Clears the result. Does not change state. (Like pressing CE on a calculator)
global.swisscalc.calc.calculator.prototype.clearEntry = function() {
	this._mainDisplay.clear();
};

// Pushes result, evaluates, and updates result.
...
// Adds parenthesis and clears result.
...
// If in a sub-expression, pushes result, applies parenthesis, and updates result.
...
// Returns the current result on the _mainDisplay.
